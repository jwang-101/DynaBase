...
bibliography={}
bibliography['Benedetto2009'] = 'Robert Benedetto, Ben Dickman, Sasha Joseph, Ben Krause, Dan Rubin, and Xinwen Zhou. Computing points of small height for cubic polynomials. Involve, 2:37--64, 2009.'
bibliography['BFHJY2018'] = 'Robert Benedetto, Xander Faber, Benjamin Hutz, Jamie Juul, Yu Yasafuku, A large arboreal Galois representation for a cubic postcritically finite polynomial.  Research in Number Theory 3:29.'
bibliography['BM2012'] = 'Nils Bruin, Alex Molnar. Minimal models for rational functions in a dynamical setting. LMS J. Comput. Math. 15 (2012) 400--417.'
...
bibliography['Poonen1998'] = 'Bjorn Poonen. The complete classificiation of rational preperiodic points of quadratic polynomials over Q: a refined conjecture. Math. Z., 228(1):11--29, 1998.'
...
my_cursor.execute("""SELECT * FROM citations""")
